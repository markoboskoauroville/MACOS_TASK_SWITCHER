...
--     .lines()            the same as the lines for the clock's stack, { "18° – 23°   rain   87%" }, or {}
...
-- 14.9.2026, once he saw the three lines: "arrange 87%. Must be in one line", then "weather data
-- should be one line, not two lines. Keep it in one line": the whole forecast is one line under the date
function W.lines()
    local w = state()

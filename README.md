...
- **A clock across the top, centred** (13.9.2026): the time, the day, and the date as day month year, white on nothing, moving with the minute while the square is open, so a glance at the switcher is a glance at the clock.
